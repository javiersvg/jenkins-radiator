...
HUDSON_TEST_IGNORE_REGEX = re.compile('nonradiator')
HUDSON_SMOKE_NAME_REGEX = re.compile('[ _]Smoke', re.I)
HUDSON_BASELINE_NAME_REGEX = re.compile('[ _]Baseline', re.I)
HUDSON_PROJECT_NAME_REGEX = re.compile('[ _]Project', re.I)
